...
class Blockchain:
    ...
    def __init__(self):
        """
        Initialise with the StellarOrigin block
        The StellarOrigin has no previous hash but uses a string of 64 zeros
        """
        self.chain = []
    ...
    def _mine_block(self, block):
        ...
        Returns:
            str: The winning hash that satisfies the target
        """
        block.nonce = 0
    ...
    def mine_pending_transactions(self, transactions):
        ...
        Args:
            transactions (list): Transactions to include
    ...
    def add_block(self, block):
        ...
        Checks:
          ...
          2. The block itself is structurally valid

        Args:
            block: A Block reconstructed from a peer's JSON payload

        Returns:
            bool: True if the block was accepted and appended
        """
    ...
    def is_chain_valid(self, chain=None):
        ...
        Walk every block in the chain and verify:
          1. Each block's stored hash matches a fresh recomp
    ...
    def from_list(cls, chain_data):
        ...
        """
        bc = cls.__new__(cls)   # skip init to avoid auto creating StellarOrigin
